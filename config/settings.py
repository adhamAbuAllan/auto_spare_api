...
APP_UPDATE_LATEST_ANDROID_VERSION = os.getenv("APP_UPDATE_LATEST_ANDROID_VERSION", "").strip()
APP_UPDATE_LATEST_ANDROID_BUILD = _env_int(os.getenv("APP_UPDATE_LATEST_ANDROID_BUILD"))
APP_UPDATE_MIN_ANDROID_VERSION = os.getenv("APP_UPDATE_MIN_ANDROID_VERSION", "").strip()
APP_UPDATE_MIN_ANDROID_BUILD = _env_int(os.getenv("APP_UPDATE_MIN_ANDROID_BUILD"))
APP_UPDATE_ANDROID_STORE_URL = os.getenv("APP_UPDATE_ANDROID_STORE_URL", "").strip()
APP_UPDATE_LATEST_IOS_VERSION = os.getenv("APP_UPDATE_LATEST_IOS_VERSION", "").strip()
APP_UPDATE_LATEST_IOS_BUILD = _env_int(os.getenv("APP_UPDATE_LATEST_IOS_BUILD"))
APP_UPDATE_MIN_IOS_VERSION = os.getenv("APP_UPDATE_MIN_IOS_VERSION", "").strip()
APP_UPDATE_MIN_IOS_BUILD = _env_int(os.getenv("APP_UPDATE_MIN_IOS_BUILD"))
APP_UPDATE_IOS_STORE_URL = os.getenv("APP_UPDATE_IOS_STORE_URL", "").strip()
